...
You are required to form teams for this project of no more than 3 students from the intensive course. Your team members can work across the stack or specialize in the design, front end, or back end portions of your project. You are also welcome to tap students from our evening courses, just ask our Community Manager to connect you. These students do work during the day but may be able to lend a different perspective to your project idea, so perhaps you may find their opinions and work useful. As you will be working in teams, you should be using Git + Github to build your project, track issues, suggest feature enhancements and ideas, and iterate over your in-progress software. Please add the instructor to your repo so they may track your progress.

An MVP (Minimum Viable Product) of your project will be due at 3pm on Wednesday, 2/10. We will spend the last 2 hours of the day presenting student project progress thus far! You'll also be graded by your instructor on the project using the following rubric topics, each graded out of 4:
...
We will be working on your projects and workshopping them in class but you are expected to put in a large amount of work outside of class. There will be team meetings on Wednesday 2/3 (before we begin working on this project) with your instructor to flesh your your initial implementation ideas.
